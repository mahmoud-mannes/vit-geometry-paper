...
\begin{itemize}
    ...
    \item \textbf{Shifting Spatial Organization Strategy:} We demonstrate that PEs push the model from a dominantly content-based strategy of forming
    ...
    \item \textbf{Enhancing Robustness to Distributional Shifts:} We show that this absolute-position-based shift is precisely what allows ViTs to remain robust to distributional shifts, such as stylization, where local patch content becomes unreliable. 
\end{itemize}
