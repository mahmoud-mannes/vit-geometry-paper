...
\section{Results}
    ...
    \subsection{Validating Emergent Spatial Structure via Extreme Counterfactuals}
        ...
        \begin{figure}[H]
            ...
            \caption{\textbf{SSDC across depth for an untrained ablated model with random permutation, a trained ablated model, and a trained intact model.} Shaded regions indicate variability across runs.}
            \label{fig:SSDC42}
        \end{figure}
