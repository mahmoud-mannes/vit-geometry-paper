...
\section{Additional Representational Analyses}
    \subsection{Spatial Structure in Untrained Intact Models}
        \begin{figure}[t]
            \centering
            \includegraphics[width=0.5\linewidth]{../figures/Appendix_SSDC_C1}
            \caption{random}
            \label{random}
        \end{figure}
    
